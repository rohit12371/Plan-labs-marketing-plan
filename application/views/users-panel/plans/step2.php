...
<div class="box-body">
	 ...
	 <div class="col-md-12"> <a  data-toggle="modal" data-target="#myModalstrength" class="popup-with-form label label-success" style="font-size: 15px;"><i class="fa fa-lightbulb-o"></i> Click Here To Start</a><strong class="text-center" style="text-align:center; display:block; font-weight:900; font-size:27px;">SWOT Analysis</strong>
          ...
          <center>  <table width="760" height="486" border="1">
              ...
              <tr>
				...
				<?php 
				$select_data1="swot_analysis_strengths";
				...
				<?php
				      $swot_first1=$swot1[0]->swot_analysis_strengths;
                ...
                <td><div id="textarea"  class="contents">
                    <?php 
				$select_data2="swot_analysis_weaknesses";
				...
				<?php
				      $swot_first2=$swot2[0]->swot_analysis_weaknesses;
              ...
              <tr>
                ...
                <td><div id="textarea"  class="contents">
                   <?php 
				$select_data3="swot_analysis_opportunities";
				...
				<?php
				      $swot_first3=$swot3[0]->swot_analysis_opportunities;
                ...
                <td><div id="textarea" class="contents">
                     <?php 
				$select_data4="swot_analysis_threats";
				...
				<?php
				      $swot_first4=$swot4[0]->swot_analysis_threats;
 ...
 <div class="box-body">
  <div class="box-body">
   ...
   <div class="col-md-12">
		  <a href="<?php echo base_url('plans/planStep1/?plan_id='.$plan_id);?>"> <button class="btn btn-success btn-large" type="button" name="submit_step1" id="back_step1" value="Save &amp; Continue" style="float: left;"> <i class="fa fa-chevron-left"></i> Back  </button></a>

         <?php $data=getswotanalysisfilled($plan_id,$user_id);
		   ...
		   <?php } else {?>
							  <?php if($data[0]->swot_analysis_strengths=='' || $data[0]->swot_analysis_weaknesses=='' || $data[0]->swot_analysis_opportunities=='' || $data[0]->swot_analysis_threats =='')
							  {?>
							  <button class="btn btn-success btn-large" type="button" id="lowdata" value="Save &amp; Continue" style="float: right;"> Save &amp; Next <i class="fa fa-chevron-right"></i> </button>
							 <?php } else { ?>
							<a href="<?php echo base_url('Plans/planstep2_pest/?plan_id='.$plan_id);?>"> <button class="btn btn-success btn-large" type="button"  value="Save &amp; Continue" style="float: right;"> Save &amp; Next <i class="fa fa-chevron-right"></i> </button></a>
							 <?php } ?>
    ...
    <div class="modal-content">
	  ...
	  <?php 
				...
				<?php
					 ...
					 {
				   ?>
				   <input type="text"  class="form-control" name="Strength[]" value="<?php echo $final1; ?>">  
    ...
    <div class="modal-content">
	  ...
	  <?php 
				...
				<?php
					 ...
					 {
				   ?>
				   <input type="text"  class="form-control" name="Weekness[]" value="<?php echo $final2; ?>"> 
      ...
      <div class="modal-body" id="Opportunities_modal">
	   ...
	   <?php 
				...
				<?php
					 ...
					 {
				   ?>
				    <input type="text"  class="form-control" name="Opportunities[]" value="<?php echo $final3; ?>">
	  ...
	  <?php 
			   ...
			   <input type="text"  class="form-control" name="Threat[]">
				...
				<?php
					 ...
					 {
				   ?>
				   <input type="text"  class="form-control" name="Threat[]" value="<?php echo $final4; ?>">
...
$('#lowdata').click(function(){
  ...
  alert('Please Filled all SWOT Analysis Properly');
			    ...
			    var fd = new FormData(this);
				 $.ajax({
				  ...
				  success: function(response){
					 ...
					 window.location.href='<?php echo base_url('Plans/planstep2_pest');?>'+'/?plan_id='+id;
				  }
				});
		}
